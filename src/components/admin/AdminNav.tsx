...
const groups = [
  { label:"Your publication", links:[{href:"/admin",label:"Overview",icon:"◫"},{href:"/admin/blog",label:"Editorial desk",icon:"▤"},{href:"/admin/journey",label:"Buying journey",icon:"↳"},{href:"/admin/tools",label:"Tools & feedback",icon:"◇"},{href:"/admin/social",label:"Social desk",icon:"◎"}] },
