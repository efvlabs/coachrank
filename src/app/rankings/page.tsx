...
import { LEADERBOARD_PAGE_SIZE, absoluteUrl } from "@/lib/config";
...
export const metadata = {
  title: "Paid coach rankings",
  description: "Coaches ranked by their cumulative bids. Paid visibility, with every amount in the open.",
  alternates: { canonical: "/rankings" },
  openGraph: { title: "Paid coach rankings", description: "Coaches ranked by their cumulative bids. Paid visibility, with every amount in the open.", url: absoluteUrl("/rankings") },
};
...
export default async function RankingsPage({ searchParams }: PageProps<"/rankings">) {
  ...
  return (
    <div className="mx-auto max-w-[1240px] px-5 sm:px-8">
      <div className="flex flex-wrap items-center justify-between gap-4 pt-7"><p className="journal-label">Paid coach rankings</p><BoardSwitch className="flex" />
      </div>
