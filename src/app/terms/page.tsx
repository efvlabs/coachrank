...
export default function TermsPage() {
  ...
  return (
    ...
    >
      ...
      <p>The Brand Clarity Assessment is a one-time $9 USD digital product, plus any applicable tax shown at checkout. It includes 24 questions, a six-dimension report, three priorities, a seven-day action plan, a downloadable PDF and lifetime access, unlimited personal retakes and side-by-side comparisons of saved reports. Saved reports remain accessible while the service is available. There is no subscription.</p>
      <p>Access opens after verified payment. New purchases are connected to the CoachRank account you sign in with before checkout. Sign in with the same email using Google or an email sign-in link to access your reports on another device. Earlier private-link purchases can be connected from My tools; keep an unconnected private link safe because anyone holding it can access or claim that purchase. Once connected, only the owning account can open it. Session expiry or signing out does not remove your purchase. Progress is saved after each section or when you select Save &amp; exit. If you lose access, contact {mail} with your payment receipt.</p>
