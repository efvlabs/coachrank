...
**How specific the problem is.** Coaching for a defined situation (a funding round, a first management hire or a partnership dispute) prices higher than open-ended development work, because the value is easier to point at.
...
What is more useful than a range: get two or three quotes for the *same* scope. Ask each coach to price the same thing: the same frequency, duration and access. The spread between comparable quotes tells you far more about the market than any survey will.

## The question that saves the most money

Before price, ask what happens if it is not working.

A coach who has a clear answer (a review point, a defined exit or a month's notice) has thought about the relationship as something you might reasonably leave. A coach who has not is selling you a contract, not a service. The answer to that question changes the value of every number that follows it.
